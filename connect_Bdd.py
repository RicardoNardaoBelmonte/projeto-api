...
app.config['SECRET_KEY'] = 'qJ3xltn6JHgUOo2D'
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:qJ3xltn6JHgUOo2D@db.gjanyvmxcqcvphgiijrd.supabase.co:5432/postgres?sslmode=require'
